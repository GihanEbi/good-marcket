  ...
  const navItems = [
    {
      label: "Dashboard",
      icon: "dashboard",
      href: "/learning/users/instructor/portal/dashboard",
    },
    {
      label: "Courses",
      icon: "school",
      href: "/learning/users/instructor/portal/courses",
    },
    {
      label: "Assignments",
      icon: "assignment",
      href: "/learning/users/instructor/portal/assignments",
    },
    {
      label: "Quizzes",
      icon: "quiz",
      href: "/learning/users/instructor/portal/quizzes",
    },
    {
      label: "Announcements",
      icon: "announcement",
      href: "/learning/users/instructor/portal/announcements",
    },
    {
      label: "Messages",
      icon: "message",
      href: "/learning/users/instructor/portal/messages",
    },
    {
      label: "Schedule",
      icon: "calendar_today",
      href: "/learning/users/instructor/portal/schedule",
    },
    {
      label: "Settings",
      icon: "settings",
      href: "/learning/users/instructor/portal/settings",
    },
  ];
