...
export default function Step3PreferencesPage() {
  ...
  const handleComplete = () => {
    ...
    router.push("/learning/users/student/registration/ai-interview/ai-intro");
  };
  ...
  return (
    <>
      ...
      <main className="flex-1 flex flex-col items-center py-6 md:py-10 px-4 w-full bg-background-light dark:bg-background-dark font-display">
        <div className="max-w-[1000px] w-full bg-white dark:bg-[#15291b] rounded-xl shadow-sm border border-[#e7f3eb] dark:border-[#1a2e21] p-6 md:p-8">
          ...
          <section className="mb-8 sm:mb-10">
            <h2 className="text-base sm:text-lg font-bold text-earth-dark dark:text-white mb-4">
                ...
                <button
                  ...
                  className={`flex flex-col gap-3 rounded-xl p-5 text-left transition-all border-2 ${
                    userData.learningStyle === style.label
                      ...
                      : "border-[#e7f3eb] dark:border-[#263d2e] bg-white dark:bg-[#1a2e21] hover:border-primary/30"
                  }`}
                >
                  ...
                  <div>
                    <h3 className="text-base font-bold text-earth-dark dark:text-white">
                      {style.label}
                    </h3>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-3 rounded-lg border transition-all font-medium text-sm ${
                    userData.studyTime === time.label
                      ? "border-primary bg-primary text-earth-dark shadow-md shadow-primary/20 font-bold"
                      : "border-[#e7f3eb] dark:border-[#263d2e] bg-white dark:bg-[#1a2e21] hover:bg-[#f6f8f6] dark:hover:bg-[#1f3526] text-earth-sage dark:text-[#a0c4ab]"
                  }`}
                >
          ...
          <section>
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={section.label}
                  className="border border-[#e7f3eb] dark:border-[#263d2e] rounded-lg bg-[#fcfdfc] dark:bg-[#1a2e21]/50 overflow-hidden"
                >
                  <div className="flex items-center justify-between p-3 border-b border-[#e7f3eb] dark:border-[#263d2e]">
                  ...
                  <div className="p-3 grid grid-cols-2 gap-4 text-sm">
                    {section.items.map((it) => (
                      <div key={it.l}>
                        <p className="text-earth-sage dark:text-[#a0c4ab] text-xs font-medium">
                          {it.l}
                        </p>
                        <p className="font-bold text-earth-dark dark:text-white">
                          {it.v}
                        </p>
                      </div>
                    ))}
      ...
      <footer className="bg-white dark:bg-[#15291b] border-t border-[#e7f3eb] dark:border-[#1a2e21] px-4 sm:px-6 lg:px-10 py-4 sm:py-6 sticky bottom-0 w-full shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] font-display">
