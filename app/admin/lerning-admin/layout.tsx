...
import { LearningAdminSidebar } from "@/components/layouts/learning-admin-layouts/LerningAdminSidebar";
import LearningAdminNavbar from "@/components/layouts/learning-admin-layouts/LearningAdminNavbar";

export default function LearningAdminLayoutShell({
  children,
}: {
    ...
    */
    <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-[#020617] text-slate-900 dark:text-slate-100 transition-colors duration-500">
      ...
      <div className="flex-1 flex flex-col overflow-hidden w-full relative">
        ...
        {/* Header */}
        <LearningAdminNavbar onMenuClick={() => setIsSidebarOpen(true)} />
