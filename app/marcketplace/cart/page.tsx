...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] font-sans text-slate-900 dark:text-white transition-colors duration-500 flex flex-col">
      ...
      {/* Footer */}
      <footer className="bg-white dark:bg-[#020617] border-t border-slate-200 dark:border-white/5 px-6 lg:px-20 py-20 mt-20">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-2 text-slate-900 dark:text-white">
                <div className="size-8 rounded-xl bg-gradient-to-tr from-emerald-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-emerald-500/20">
                  <svg
              ...
              <p className="text-sm text-slate-500 leading-relaxed font-medium">
                The ethical marketplace for people and planet. We believe in
                transparency, sustainability, and the power of the circular
                economy.
              </p>
              <div className="flex gap-4">
                {["public", "mail", "alternate_email"].map((icon) => (
                  <button
                    key={icon}
                    className="size-10 rounded-xl border border-slate-200 dark:border-white/10 flex items-center justify-center hover:bg-emerald-500 hover:text-white hover:border-emerald-500 transition-colors text-slate-400"
                  >
                    <span className="material-symbols-outlined text-lg">
                      {icon}
                    </span>
            ...
            {[
              ...
              <div key={section.title}>
                <h4 className="font-black mb-6 text-slate-900 dark:text-white uppercase tracking-widest text-xs">
                  {section.title}
                </h4>
                <ul className="flex flex-col gap-4 text-sm font-bold text-slate-500">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  className="flex-1 bg-slate-100 dark:bg-white/5 border-none rounded-xl px-4 text-sm font-bold focus:ring-2 focus:ring-emerald-500/20 placeholder:text-slate-400 outline-none"
                  placeholder="Email"
                  type="email"
                />
                <button className="bg-emerald-500 text-white px-6 py-2 rounded-xl font-black text-sm hover:shadow-lg hover:shadow-emerald-500/20 transition-all uppercase tracking-wider">
                  Join
                </button>
              </div>
            </div>
          ...
          <div className="pt-8 border-t border-slate-200 dark:border-white/5 flex flex-wrap justify-between items-center gap-6">
